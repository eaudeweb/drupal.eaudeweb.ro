...
/* themes/blinds/templates/node/node.html.twig */
class __TwigTemplate_cf17f057749822906addf05f4ed224d3adf827cca136848b5d9b1fd99ec60151 extends Twig_Template
{
...
(isset($context["view_mode"]) ? $context["view_mode"] : null)) ? (\Drupal\Component\Utility\Html::getClass((isset($context["view_mode"]) ? $context["view_mode"] : null))) : ("")), 5 => "clearfix");
  ...
  ";
      ...
      <div";
        ...
        ";
            // line 90
            echo t("<span class=\"label label-default\">by <span class=\"glyphicon glyphicon-user\"></span>@author_name on @date</span>", array("@author_name" => (isset($context["author_name"]) ? $context["author_name"] : null), "@date" => (isset($context["date"]) ? $context["date"] : null), ));
            // line 91
            echo "        ";
...
";
    ...
    {
        return "themes/blinds/templates/node/node.html.twig";
    }
...
/*         {% trans %}<span class="label label-default">by <span class="glyphicon glyphicon-user"></span>{{ author_name }} on {{ date }}</span>{% endtrans %}*/
/*         {{ metadata }}*/
/*       </div>*/
/*     </footer>*/
/*   {% endif %}*/
