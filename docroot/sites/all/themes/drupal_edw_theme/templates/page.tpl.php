...
<div id="header_wrapper">
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      <?php if (theme_get_setting('social_links', 'drupal_edw_theme')):
        global $base_url;
        ?>
      <div class="social-icons">
       <ul>
        <li><a href="<?php print $base_url; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'drupal_edw_theme') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
        <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'drupal_edw_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'drupal_edw_theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
        <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'drupal_edw_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'drupal_edw_theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
       </ul>
      </div>
    <?php endif; ?>
  ...
  <div id="container">
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 'drupal_edw_theme')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
